...
const ERROR_MESSAGES = {
  ...
  CAPTURE_SVG_COMPLEXITY_LIMIT: 'The SVG traversal exceeds the supported complexity.',
  CAPTURE_SVG_TEXT_LIMIT: 'The SVG text exceeds the supported measurement budget.',
  CAPTURE_SVG_INVALID_GEOMETRY: 'The SVG has invalid geometry.',
